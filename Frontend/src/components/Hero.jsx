      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-left">
          ...
          <div className="flex items-center gap-4">
            <button onClick={handleGetStarted} className="px-6 py-3 rounded-xl bg-neutral-900 text-neutral-100 font-medium hover:bg-neutral-800 transition-all shadow-md">
              Get Started
            </button>
        ...
        <div className="flex justify-center">
          <div className="w-100 h-100 md:w-96 md:h-96 overflow-hidden ">
            {/* <img
              src="/banner.png"
